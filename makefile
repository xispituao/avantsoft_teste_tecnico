...
rubocop:
	docker compose -f docker-compose.yml --env-file .env exec app bin/rubocop
rubocop-fix:
	docker compose -f docker-compose.yml --env-file .env exec app bin/rubocop -A
brakeman:
	docker compose -f docker-compose.yml --env-file .env exec app bin/brakeman --no-pager
swagger:
	docker compose -f docker-compose.yml --env-file .env exec app bundle exec rake rswag:specs:swaggerize
down:
	docker compose -f docker-compose.yml --env-file .env down
restart:
	docker compose -f docker-compose.yml --env-file .env restart app
logs:
